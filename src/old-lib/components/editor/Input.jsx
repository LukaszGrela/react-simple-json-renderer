...
export default class Input extends React.Component {
  ...
  render() {
    ...
    return (
      <div style={style} onMouseEnter={this.hoverStarted} onMouseLeave={this.hoverStopped}>
        <Label
          value={label}
          styles={styles}
        ...
        <div style={styles.value}>
          ...
          {type === 'boolean' && (
            <select style={styles.select} value={value === 'true'} onChange={this.onValueChanged}>
              <option value='true'>True</option>
              <option value='false'>False</option>
            </select>
          )}
          {(type === 'text' || type === 'number') && (
            <input style={styles.input} type={type} value={value} onChange={this.onValueChanged} />
          )}
        </div>
